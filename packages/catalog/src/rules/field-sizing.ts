...
input[type="text"] {
  ...
  agent: {
    ...
    unless: [
      "Your support target reaches below Chrome {{chrome:field-sizing}}, Firefox {{firefox:field-sizing}} or Safari {{safari:field-sizing}}. Every engine ships field-sizing now, but Firefox and Safari only in 2026, so an older target still needs the fallback.",
