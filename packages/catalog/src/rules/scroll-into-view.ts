...
option.scrollIntoView({
  ...
  agent: {
    ...
    unless: [
      ...
      "Your support target reaches below Chrome {{chrome:api.Element.scrollIntoView.options_parameter}}, Firefox {{firefox:api.Element.scrollIntoView.options_parameter}} or Safari {{safari:api.Element.scrollIntoView.options_parameter}}. The method is far older than that, so scrollIntoView() existing is not proof the options object is read.",
    ],
